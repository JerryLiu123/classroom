...
//import com.classroom.wnn.task.TaskImportTest;
...
////		HadoopServer server = HadoopServer.getInstance();
////		//server.listDataNodeInfo();
////		System.out.println(server.checkFileExist("/data/lgh/myTest.txt"));
